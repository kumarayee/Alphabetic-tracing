...
function draw() {
  ...
  vertices = [[windowWidth*0.4055,windowHeight*0.70],
  [windowWidth*0.4925,windowHeight*0.35],
  [windowWidth*0.586,windowHeight*0.700],
  [windowWidth*0.43,windowHeight*0.628],
  [windowWidth*0.55,windowHeight*0.628]]

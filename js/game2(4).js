...
function draw() {
  ...
  vertices = [[windowWidth*0.21,windowHeight*0.4726],
  [windowWidth*0.22,windowHeight*0.4137],
  [windowWidth*0.24,windowHeight*0.3795],
  [windowWidth*0.27,windowHeight*0.3795],
  [windowWidth*0.29,windowHeight*0.4219],
  [windowWidth*0.29,windowHeight*0.4945],
  [windowWidth*0.26,windowHeight*0.5479],
  [windowWidth*0.24,windowHeight*0.5836],
  [windowWidth*0.21,windowHeight*0.6247],
  [windowWidth*0.30,windowHeight*0.6260],
  [windowWidth*0.37,windowHeight*0.4671],
  [windowWidth*0.39,windowHeight*0.3959],
  [windowWidth*0.42,windowHeight*0.3753],
  [windowWidth*0.46,windowHeight*0.4096],
  [windowWidth*0.46,windowHeight*0.4644],
  [windowWidth*0.44,windowHeight*0.5233],
  [windowWidth*0.41,windowHeight*0.5726],
  [windowWidth*0.37,windowHeight*0.6260],
  [windowWidth*0.46,windowHeight*0.6247],
  [windowWidth*0.54,windowHeight*0.4699],
  [windowWidth*0.55,windowHeight*0.4027],
  [windowWidth*0.59,windowHeight*0.3767],
  [windowWidth*0.62,windowHeight*0.3986],
  [windowWidth*0.63,windowHeight*0.4575],
  [windowWidth*0.61,windowHeight*0.5205],
  [windowWidth*0.58,windowHeight*0.5753],
  [windowWidth*0.54,windowHeight*0.6260],
  [windowWidth*0.63,windowHeight*0.6260],
  [windowWidth*0.70,windowHeight*0.4699],
  [windowWidth*0.72,windowHeight*0.4000],
  [windowWidth*0.75,windowHeight*0.3740],
  [windowWidth*0.78,windowHeight*0.4055],
  [windowWidth*0.79,windowHeight*0.4726],
  [windowWidth*0.77,windowHeight*0.5384],
  [windowWidth*0.74,windowHeight*0.5877],
  [windowWidth*0.70,windowHeight*0.6315],
  [windowWidth*0.80,windowHeight*0.6247],
  ]

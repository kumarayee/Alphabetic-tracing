...
function draw() {
  ...
  vertices = [[windowWidth*0.43,windowHeight*0.37],
              [windowWidth*0.43,windowHeight*0.70],
              [windowWidth*0.52,windowHeight*0.37],
              [windowWidth*0.533,windowHeight*0.38],
              [windowWidth*0.545,windowHeight*0.41],
              [windowWidth*0.55,windowHeight*0.43],
              [windowWidth*0.552,windowHeight*0.45],
              [windowWidth*0.551,windowHeight*0.47],
              [windowWidth*0.54,windowHeight*0.49],
              [windowWidth*0.52,windowHeight*0.525],
              [windowWidth*0.45,windowHeight*0.525],
              [windowWidth*0.54,windowHeight*0.55],
              [windowWidth*0.55,windowHeight*0.57],
              [windowWidth*0.56,windowHeight*0.61],
              [windowWidth*0.556,windowHeight*0.66],
              [windowWidth*0.545,windowHeight*0.69],
              [windowWidth*0.53,windowHeight*0.70]]

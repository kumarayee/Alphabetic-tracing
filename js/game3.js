...
function draw() {
  ...
  vertices = [[windowWidth*0.45,windowHeight*0.4534],
  [windowWidth*0.47,windowHeight*0.3849],
  [windowWidth*0.51,windowHeight*0.3603],
  [windowWidth*0.54,windowHeight*0.4068],
  [windowWidth*0.54,windowHeight*0.4863],
  [windowWidth*0.51,windowHeight*0.5301],
  [windowWidth*0.55,windowHeight*0.5603],
  [windowWidth*0.57,windowHeight*0.6370],
  [windowWidth*0.56,windowHeight*0.7247],
  [windowWidth*0.51,windowHeight*0.7658],
  [windowWidth*0.47,windowHeight*0.7589],
  [windowWidth*0.44,windowHeight*0.7055],
  [windowWidth*0.43,windowHeight*0.6205],
  ]

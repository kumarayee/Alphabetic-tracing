...
function draw() {
  ...
  vertices = [[windowWidth*0.20,windowHeight*0.3288],
  [windowWidth*0.27,windowHeight*0.3315],
  [windowWidth*0.26,windowHeight*0.3795],
  [windowWidth*0.26,windowHeight*0.6712],
  [windowWidth*0.37,windowHeight*0.3301],
  [windowWidth*0.44,windowHeight*0.3274],
  [windowWidth*0.43,windowHeight*0.3808],
  [windowWidth*0.43,windowHeight*0.6740],
  [windowWidth*0.55,windowHeight*0.3301],
  [windowWidth*0.62,windowHeight*0.3274],
  [windowWidth*0.60,windowHeight*0.3890],
  [windowWidth*0.60,windowHeight*0.6753],
  [windowWidth*0.72,windowHeight*0.3301],
  [windowWidth*0.79,windowHeight*0.3329],
  [windowWidth*0.77,windowHeight*0.3849],
  [windowWidth*0.77,windowHeight*0.6753],
  ]

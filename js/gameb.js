...
function draw() {
  ...
  vertices = [[windowWidth*0.44,windowHeight*0.29],
              [windowWidth*0.44,windowHeight*0.71],
              [windowWidth*0.48,windowHeight*0.47],
              [windowWidth*0.50,windowHeight*0.44],
              [windowWidth*0.52,windowHeight*0.43],
              [windowWidth*0.54,windowHeight*0.431],
              [windowWidth*0.56,windowHeight*0.446],
              [windowWidth*0.58,windowHeight*0.468],
              [windowWidth*0.60,windowHeight*0.515],
              [windowWidth*0.605,windowHeight*0.55],

              [windowWidth*0.605,windowHeight*0.60],
              [windowWidth*0.60,windowHeight*0.64],
              [windowWidth*0.58,windowHeight*0.70],
              [windowWidth*0.56,windowHeight*0.72],
              [windowWidth*0.54,windowHeight*0.724],
              [windowWidth*0.52,windowHeight*0.726],
              [windowWidth*0.50,windowHeight*0.71],
              [windowWidth*0.48,windowHeight*0.68],
            ]

...
function draw() {
  ...
  vertices = ClipPath = [[[windowWidth*0.5188,windowHeight*0.3053],
  [windowWidth*0.5206,windowHeight*0.3713],
  [windowWidth*0.5206,windowHeight*0.5653],
  [windowWidth*0.5212,windowHeight*0.6662],
  [windowWidth*0.5206,windowHeight*0.7814],
  [windowWidth*0.5219,windowHeight*0.8422],
  ],[[windowWidth*0.4075,windowHeight*0.3609],
  [windowWidth*0.4569,windowHeight*0.3545],
  [windowWidth*0.5294,windowHeight*0.3558],
  [windowWidth*0.5519,windowHeight*0.3545],
  ],]
[0.075,0.05625]

...
function draw() {
  ...
  vertices = [[windowWidth*0.333,windowHeight*0.50],
              [windowWidth*0.397,windowHeight*0.267],
              [windowWidth*0.460,windowHeight*0.50],
              [windowWidth*0.37,windowHeight*0.45],
              [windowWidth*0.42,windowHeight*0.45],
            
              [windowWidth*0.54,windowHeight*0.50],
              [windowWidth*0.604,windowHeight*0.267],
              [windowWidth*0.667,windowHeight*0.50],
              [windowWidth*0.577,windowHeight*0.45],
              [windowWidth*0.627,windowHeight*0.45],
            
              [windowWidth*0.54,windowHeight*0.89],
              [windowWidth*0.604,windowHeight*0.657],
              [windowWidth*0.667,windowHeight*0.89],
              [windowWidth*0.577,windowHeight*0.84],
              [windowWidth*0.627,windowHeight*0.84],

              [windowWidth*0.333,windowHeight*0.89],
              [windowWidth*0.397,windowHeight*0.657],
              [windowWidth*0.460,windowHeight*0.89],
              [windowWidth*0.37,windowHeight*0.84],
              [windowWidth*0.42,windowHeight*0.84]]

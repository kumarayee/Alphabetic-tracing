...
function draw() {
  ...
  vertices = [[windowWidth*0.351,windowHeight*0.221],
              [windowWidth*0.351,windowHeight*0.48],

              [windowWidth*0.375,windowHeight*0.325],
              [windowWidth*0.39,windowHeight*0.31],
              [windowWidth*0.41,windowHeight*0.30],
              [windowWidth*0.43,windowHeight*0.31],
              [windowWidth*0.448,windowHeight*0.34],
              [windowWidth*0.453,windowHeight*0.37],
              [windowWidth*0.455,windowHeight*0.40],
              [windowWidth*0.453,windowHeight*0.435],
              [windowWidth*0.443,windowHeight*0.46],
              [windowWidth*0.43,windowHeight*0.475],
              [windowWidth*0.41,windowHeight*0.483],
              [windowWidth*0.39,windowHeight*0.48],
              [windowWidth*0.375,windowHeight*0.465],

              [windowWidth*0.351,windowHeight*0.575],//
              [windowWidth*0.351,windowHeight*0.84],

              [windowWidth*0.375,windowHeight*0.679],
              [windowWidth*0.39,windowHeight*0.664],
              [windowWidth*0.41,windowHeight*0.654],
              [windowWidth*0.43,windowHeight*0.664],
              [windowWidth*0.448,windowHeight*0.694],
              [windowWidth*0.453,windowHeight*0.724],
              [windowWidth*0.455,windowHeight*0.754],
              [windowWidth*0.453,windowHeight*0.789],
              [windowWidth*0.443,windowHeight*0.814],
              [windowWidth*0.43,windowHeight*0.829],
              [windowWidth*0.41,windowHeight*0.837],
              [windowWidth*0.39,windowHeight*0.834],
              [windowWidth*0.375,windowHeight*0.819],

              [windowWidth*0.5415,windowHeight*0.575],//
              [windowWidth*0.5415,windowHeight*0.84],

              [windowWidth*0.5655,windowHeight*0.679],
              [windowWidth*0.5805,windowHeight*0.664],
              [windowWidth*0.6005,windowHeight*0.654],
              [windowWidth*0.6205,windowHeight*0.664],
              [windowWidth*0.6385,windowHeight*0.694],
              [windowWidth*0.6435,windowHeight*0.724],
              [windowWidth*0.6455,windowHeight*0.754],
              [windowWidth*0.6435,windowHeight*0.789],
              [windowWidth*0.6335,windowHeight*0.814],
              [windowWidth*0.6205,windowHeight*0.829],
              [windowWidth*0.6005,windowHeight*0.837],
              [windowWidth*0.5805,windowHeight*0.834],
              [windowWidth*0.5655,windowHeight*0.819],

              // [windowWidth*0.5415,windowHeight*0.221],//
              // [windowWidth*0.5415,windowHeight*0.48],

...
function draw() {
  ...
  vertices = [[windowWidth*0.58,windowHeight*0.3133],
  [windowWidth*0.58,windowHeight*0.7838],
  [windowWidth*0.56,windowHeight*0.5401],
  [windowWidth*0.53,windowHeight*0.4958],
  [windowWidth*0.50,windowHeight*0.4726],
  [windowWidth*0.47,windowHeight*0.4747],
  [windowWidth*0.44,windowHeight*0.4947],
  [windowWidth*0.42,windowHeight*0.5443],
  [windowWidth*0.41,windowHeight*0.6266],
  [windowWidth*0.41,windowHeight*0.6888],
  [windowWidth*0.43,windowHeight*0.7405],
  [windowWidth*0.46,windowHeight*0.7658],
  [windowWidth*0.49,windowHeight*0.7774],
  [windowWidth*0.53,windowHeight*0.7532],
  [windowWidth*0.56,windowHeight*0.7205],
  ]

...
function draw() {
  ...
  vertices = [[windowWidth*0.60,windowHeight*0.6233],
  [windowWidth*0.42,windowHeight*0.6233],
  [windowWidth*0.44,windowHeight*0.5356],
  [windowWidth*0.52,windowHeight*0.3521],
  [windowWidth*0.56,windowHeight*0.3452],
  [windowWidth*0.56,windowHeight*0.7329],
  ]

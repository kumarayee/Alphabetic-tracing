...
function draw() {
  ...
  vertices = [[windowWidth*0.54,windowHeight*0.4849],
    [windowWidth*0.51,windowHeight*0.4384],
    [windowWidth*0.47,windowHeight*0.4397],
    [windowWidth*0.45,windowHeight*0.4603],
    [windowWidth*0.42,windowHeight*0.4986],
    [windowWidth*0.41,windowHeight*0.5699],
    [windowWidth*0.41,windowHeight*0.6397],
    [windowWidth*0.44,windowHeight*0.7027],
    [windowWidth*0.46,windowHeight*0.7301],
    [windowWidth*0.50,windowHeight*0.7356],
    [windowWidth*0.53,windowHeight*0.7151],
    [windowWidth*0.55,windowHeight*0.6795],
    [windowWidth*0.57,windowHeight*0.4219],
    [windowWidth*0.57,windowHeight*0.5123],
    [windowWidth*0.57,windowHeight*0.6041],
    [windowWidth*0.57,windowHeight*0.7027],
    [windowWidth*0.57,windowHeight*0.7562],
    ]
